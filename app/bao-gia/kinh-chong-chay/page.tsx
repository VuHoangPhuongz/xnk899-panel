    ...
    return (
        <>
            ...
            <div className="overflow-x-auto border rounded-lg my-6 not-prose">
              ...
              <p>Báo giá  kính chống cháy phụ thuộc bởi nhiều yếu tố như các số liệu, kích thước, giới hạn chịu lửa, chi phí lắp đặt. Vì vậy, để nhận được báo giá chính xác và tốt nhất, Quý khách hàng vui lòng liên hệ trực tiếp với chúng tôi.</p>
