...
import SearchOverlay from './SearchOverlay'; // Dùng cho mobile search
...
const Header = () => {
  ...
  return (
    <>
            ...
            <div className="w-full bg-gradient-to-r from-blue-800 via-green-600 to-transparent text-white text-sm">
                <div className="container mx-auto px-4 flex justify-between items-center py-2">
                    <div className="flex items-center space-x-2">
                        ...
                        <span>0987822311 / 0384358988 / 0383522018</span>
                    </div>
      ...
      <CartSidebar />
      {/* Search Overlay dùng cho mobile */}
